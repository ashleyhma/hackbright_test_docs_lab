...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type(treats = [{'type': 'dessert'}, {'type': 'dessert'},{'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'drink'}])
    ('dessert', 'drink')

    >>> most_and_least_common_type(treats = [{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'dessert'}])
    ('dessert', 'dessert')

    >>> most_and_least_common_type(treats = [{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'appetizer'}])
    ('dessert', 'dessert')
    
    >>> most_and_least_common_type(treats = [{'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'appetizer'}])
    ('dessert', 'dessert')
